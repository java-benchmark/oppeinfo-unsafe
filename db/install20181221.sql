...
add column "add_info" varchar(4000)	 NULL,    -- õppurile kuvatv lisainfo
add column 	"is_outcomes" boolean NULL,    -- kas ÕV lähevad arvesse keskimse arvutamisel
add column 	"is_period_grade" boolean NULL,    -- kas periodi hinne läheb arvesse keskimise arvutamisel
add column 	"is_journal_final_grade" boolean NULL,    -- kas päeviku lõpphinne läheb arvesse keskimise arvutamisel
add column 	"is_module_grade" boolean NULL,    -- kas mooduli hinne läheb arvesse keskimise arvutamisel
add column 	"is_apel_grade" boolean NULL,    -- kas VÕTA hinne läheb arvesse keskimise arvutamisel
add column 	"is_journal_grade" boolean NULL,    -- kas päeviku HINDAMINE hinne läheb arvesse keskimise arvutamisel
add column 	"last_period_grade_from" date NULL,    -- eelmise perioodi algis
add column 	"last_period_grade_thru" date NULL,    -- eelmise perioodi lõpp
add column 	"is_last_period_outcomes" boolean NULL,    -- kas ÕV lähevad arvesse eelmise perioodi keskimse arvutamisel
add column 	"is_last_period_period_grade" boolean NULL,    -- kas periodi hinne läheb arvesse eelmise perioodi keskimise arvutamisel
add column 	"is_last_period_journal_final_grade" boolean NULL,    -- kas päeviku lõpphinne läheb arvesse eelmise perioodi keskimise arvutamisel
add column 	"is_last_period_module_grade" boolean NULL,    -- kas mooduli hinne läheb arvesse eelmise perioodi keskimise arvutamisel
add column 	"is_last_period_apel_grade" boolean NULL,    -- kas VÕTA hinne läheb arvesse eelmise perioodi keskimise arvutamisel
add column 	"is_last_period_journal_grade" boolean NULL    -- kas päeviku HINDAMINE hinne läheb arvesse eelmise perioodi keskimise arvutamisel
;

COMMENT ON COLUMN "scholarship_term"."add_info"	IS 'õppurile kuvatv lisainfo';
COMMENT ON COLUMN "scholarship_term"."is_outcomes"	IS 'kas ÕV lähevad arvesse keskimse arvutamisel';
COMMENT ON COLUMN "scholarship_term"."is_period_grade"	IS 'kas periodi hinne läheb arvesse keskimise arvutamisel';
COMMENT ON COLUMN "scholarship_term"."is_journal_final_grade"	IS 'kas päeviku lõpphinne läheb arvesse keskimise arvutamisel';
COMMENT ON COLUMN "scholarship_term"."is_module_grade"	IS 'kas mooduli hinne läheb arvesse keskimise arvutamisel';
COMMENT ON COLUMN "scholarship_term"."is_apel_grade"	IS 'kas VÕTA hinne läheb arvesse keskimise arvutamisel';
COMMENT ON COLUMN "scholarship_term"."is_journal_grade"	IS 'kas päeviku HINDAMINE hinne läheb arvesse keskimise arvutamisel';
COMMENT ON COLUMN "scholarship_term"."last_period_grade_from"	IS 'eelmise perioodi algus';
COMMENT ON COLUMN "scholarship_term"."last_period_grade_thru"	IS 'eelmise perioodi lõpp';
COMMENT ON COLUMN "scholarship_term"."is_last_period_outcomes"	IS 'kas ÕV lähevad arvesse eelmise perioodi keskimse arvutamisel';
COMMENT ON COLUMN "scholarship_term"."is_last_period_period_grade"	IS 'kas periodi hinne läheb arvesse eelmise perioodi keskimise arvutamisel';
COMMENT ON COLUMN "scholarship_term"."is_last_period_journal_final_grade"	IS 'kas päeviku lõpphinne läheb arvesse eelmise perioodi keskimise arvutamisel';
COMMENT ON COLUMN "scholarship_term"."is_last_period_module_grade"	IS 'kas mooduli hinne läheb arvesse eelmise perioodi keskimise arvutamisel';
COMMENT ON COLUMN "scholarship_term"."is_last_period_apel_grade"	IS 'kas VÕTA hinne läheb arvesse eelmise perioodi keskimise arvutamisel';
COMMENT ON COLUMN "scholarship_term"."is_last_period_journal_grade"	IS 'kas päeviku HINDAMINE hinne läheb arvesse eelmise perioodi keskimise arvutamisel';

alter table apel_application_formal_replaced_subject_or_module add column curriculum_version_omodule_theme_id bigint;
comment on column apel_application_formal_replaced_subject_or_module.curriculum_version_omodule_theme_id is 'asendatav teema';
create index IXFK_apel_application_formal_replaced_subject_or_module_X on apel_application_formal_replaced_subject_or_module(curriculum_version_omodule_theme_id);
alter table apel_application_formal_replaced_subject_or_module add constraint FK_apel_application_formal_replaced_subject_or_module_X foreign key(curriculum_version_omodule_theme_id) references curriculum_version_omodule_theme(id);

update classifier set name_et='Õppija' where code='ROLL_T';
update classifier set extraval1='Admin. töötaja' where code='ROLL_A';
update classifier set extraval1='Esindaja' where code='ROLL_L';
